Bienvenido al archivo Readme para el ejercicio de Automatizacion de API!
Estas pruebas de API fueron desarrolladas usando Cypress.io.
A continuacion se presentan los pasos para la ejecucion de las pruebas.

Pre-requisitos:
1. instalar Cypress a traves del comando mpn install Cypress
